...
include 'conexion.php';
        $re=$con->query("select sum(compras.subtotal) as total,usuarios.nombre from compras join usuarios
on compras.idusuario=usuarios.id where fecha between '".$_GET['fechai']."' and '".$_GET['fechaf']."'
